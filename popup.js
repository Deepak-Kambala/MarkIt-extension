    ...
    exportPdfBtn.addEventListener('click', function() {
        ...
        try {
            ...
            currentHighlights.forEach((highlight, index) => {
                ...
                // --- Highlight Text with Light Background ---
                const textLines = doc.splitTextToSize(highlight.text, maxWidth);
                const textHeight = textLines.length * 5 + 5;

                doc.setFillColor(250, 250, 255); // very light bluish-white background
                doc.roundedRect(margin - 2, y - 4, maxWidth + 4, textHeight + 4, 2, 2, "F");
                ...
                if (highlight.tags && highlight.tags.length > 0) {
                    ...
                    highlight.tags.forEach(tag => {
                       ...
                       doc.setFillColor(230, 230, 250); // lavender tag badge
                ...
                if (highlight.source) {
                     ...
                     doc.textWithLink(`🔗 ${highlight.source}`, margin, y, { url: highlight.source });
                     y += 5;
                }
                ...
                if (highlight.date) {
                    ...
                    doc.text(`🕒 ${highlight.date}`, margin, y);
                    y += 15;
                }

                // Reset text color for next highlight
                doc.setTextColor(0, 0, 0);
        });
